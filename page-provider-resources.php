...
<div class="py-16 bg-white">
    <div class="relative flex flex-col md:flex-row items-center max-w-screen-xl mx-auto">
        <div class="w-full order-1 md:order-1 md:w-1/2 pr-8">
            <p class="text-2xl md:text-5xl leading-[3rem] mb-2 font-gotham-bold text-blue">
                Provider Resources
            </p>
            <p class="font-gotham-light leading-7 mb-4 text-lg">
                Get access to videos and links on a variety of topics.
            </p>
        </div>
        <div class="w-full order-0 md:order-1 md:w-1/2">
            <div class="rounded-xl overflow-hidden relative w-full flex-1 aspect-[5/3] shadow-xl">
                <img class="h-full w-full object-cover" src="https://project-teach.launchpaddev.com/app/uploads/2020/04/iStock-514226028.jpg">
            </div>
        </div>
    </div>
</div>
...
<div class="px-4 py-16 md:px-0">
    <section class="max-w-screen-lg lg:max-w-screen-xl mx-auto">
        <h2 class="text-blue font-bold text-2xl md:text-3xl mb-6">Provider Resources</h2>
...
<div class="pb-16 relative max-w-screen-lg lg:max-w-screen-xl mx-auto px-4 md:px-0">
    <div class="relative rounded-xl overflow-hidden shadow-xl">
        <div class="md:absolute h-full w-full md:bg-[length:80%] bg-center md:bg-[190%_0%] aspect-video md:aspect-none bg-cover bg-no-repeat" style="
                    background-image: url('https://project-teach.launchpaddev.com/app/uploads/2020/10/Untitled-1.jpg'); 
                ">
        </div>
        <div class="hidden md:block absolute h-full w-full bg-gradient-to-r from-white via-white"></div>
        <div class="relative mt-auto px-4 md:px-6 md:py-16 md:w-1/2">
            <p class="text-2xl md:text-3xl mb-2 font-gotham-bold text-purple">Join Project TEACH's Learning Management System (LMS)</p>
            <p class="font-gotham text-lg md:font-gotham-bold text-blue mb-2">On-Demand, CME-Certified Education</p>
            <p class="font-gotham-light leading-7 mb-4 text-lg">Access past Project TEACH training programs on Maternal and Children's Mental Health topics to earn CME and enhance your ability to care for those you serve.</p>
            <div class="">
                <a class="border-solid border-2 border-purple font-gotham-bold inline-block no-underline text-white rounded-full px-4 py-2 transition-all duration-300 hover:bg-transparent hover:text-purple bg-purple" title="learn more about consultations" href="/courses">View Courses</a>
            </div>
        </div>
    </div>
</div>
...
<section class="pb-16 px-4 md:px-0" x-data="{ section1: true, section2: false, section3: false, section4:false}">
    <h2 class="md:text-center font-gotham-bold text-2xl md:text-3xl mb-12">Provider Resources From Around the Web</h2>
