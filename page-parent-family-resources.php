...
<div class="py-16 max-w-screen-lg lg:max-w-screen-xl mx-auto">
    <p class="text-2xl md:text-3xl mb-2 font-gotham-bold">Importance Of Good Child Mental Health
    </p>
    <p class="font-gotham-light leading-7 mb-4 text-lg">
        ...
        <div class="md:aspect-square relative rounded-xl overflow-hidden shadow-xl">
            ...
            <div class="relative p-4 flex flex-col text-white h-full">
                ...
                <div class="mt-auto flex-1 flex flex-col">
                    <p class="text-2xl mb-2 font-gotham-bold text-white leading-tight">Why is Good Mental Health Important for Your Child?</p>
                    <p class="font-gotham-light text-base mb-4">Good mental health empowers children to live their best lives, positively impacting development, learning, peer interactions, and achieving their full potential.</p>
                </div>
            </div>
        </div>
        <div class="md:aspect-square relative rounded-xl overflow-hidden shadow-xl">
            ...
            <div class="relative p-4 flex flex-col text-white h-full">
                ...
                <div class="mt-auto flex-1 flex flex-col">
                    <p class="text-2xl mb-2 font-gotham-bold text-white leading-tight">As a Parent, How Can You Help?</p>
                    <p class="font-gotham-light text-base mb-4">Promoting good mental health involves all of us. Parents and family can play a vital role by recognizing early warning signs in children and adolescents.</p>
                </div>
            </div>
        </div>
        <div class="md:aspect-square relative rounded-xl overflow-hidden shadow-xl">
            ...
            <div class="relative p-4 flex flex-col text-white h-full">
                ...
                <div class="mt-auto flex-1 flex flex-col">
                    <p class="text-2xl mb-2 font-gotham-bold text-white leading-tight">How Does Early Identification Help?</p>
                    <p class="font-gotham-light text-base mb-4">It enables parents to find resources, facilitates open dialogue with healthcare providers, and ensures access to needed mental health care for their child.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="px-4 md:px-0">
    <section class="max-w-screen-lg lg:max-w-screen-xl mx-auto">
        <h2 class="text-blue font-bold text-2xl md:text-3xl mb-6">Parent & Family Resources</h2>
...
<section class="pb-16 px-4 md:px-0" x-data="{ section1: true, section2: false, section3: false, section4:false}">
    <h2 class="md:text-center font-gotham-bold text-2xl md:text-3xl mb-12">Parent & Family Resources From Around the Web</h2>
