                  ...
                  <?php
                    ...
                    while ( $loop->have_posts() ) : $loop->the_post();                     
                        ...
                        if (get_field('start_date') < date('Ymd')) : 
                            if (!$pastTitleAdded) : ?>
                                <p id="past-title" style="order:1;text-align: center; margin-bottom: 20px; color: #4806a6; font-weight: bold; font-size: 24px;">Past Events</p>
            	        ...
            	        <div class="event__card-wrap <?php if(get_field('featured')) { 
                                ...
                                echo 'passed"'; 
                                echo 'style="order:' . $descendingCount . ';"';
                            }
                            ?>">                
                	        <div style="flex-wrap:wrap;" class="card card-<?php echo $counter; if ($oldEvent) {echo ' event__passed';} else{ echo '';}?> event__card">
                                ...
                                <?php if(has_post_thumbnail()): ?>                                    
                                    <a href="<?php the_field("registration_link"); ?>" class="event__image-wrap">
                        	            <div class="event__image-overlay">
                                            <!-- <?php if ($oldEvent) {
                                                echo 'EVENT<br>NO<br>LONGER<br>AVAILABLE';
                                            } else{ 
                                                echo '';
                                            }?>  -->
							            </div>
                                ...
                                <div style="width:100%; margin:15px 0; text-align:right">
                                    ...
                                    <a class="btn btn-orange" href="<?php echo get_template_directory_uri();?>/assets/images/fupt-2020-it.pdf">Download Print Version</a>
                                </div>
                                ...
                                <!-- <p style="width:100%; padding:0 15px;">
                                    <a style="float:right;" class="btn btn-<?php echo $currentRegion;?>" href="<?php the_field("registration_link"); ?>">Register Now</a>                
                                </p> -->
                	        </div>                	        
                        </div>
                        <?php $descendingCount--;?>
