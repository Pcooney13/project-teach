    ...
    <div class="relative flex flex-col md:flex-row items-center max-w-screen-xl mx-auto">
        <div class="w-full order-1 md:order-1 md:w-1/2 pr-8">
            ...
            <div class="flex ml-auto items-center mb-4">
                ...
                <!-- TWITTER -->
                <a href="">
                    <svg class="w-6 h-6 text-cool-gray transition hover:text-blue mx-2" fill="currentColor" viewBox="0 0 24 24">
                ...
                <!-- FB	 -->
                <a href="https://www.facebook.com/sharer/sharer.php?u=https://project-teach.launchpaddev.com/pt_resources/the-motherhood-center-of-new-york/" target="_blank" follow="nofollow">
                    <svg class="w-6 h-6 text-cool-gray transition hover:text-blue mx-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="gap-2 flex flex-col mb-8">
                <p class="text-2xl md:text-3xl font-gotham-bold">
                    The Use of Trauma-Informed Care: A Teenaged Girl With a History of Adverse Childhood Experiences
                </p>
                <div class="flex items-center">
                    <div class="flex items-center text-slate-500 gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mb-1" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            <path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0"></path>
                            <path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2"></path>
                            <path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
                            <path d="M21 21v-2a4 4 0 0 0 -3 -3.85"></path>
                        </svg><a href="https://project-teach.launchpaddev.com/consultants/maureen-montgomery-md/" class="font-gotham text-slate-500 hover:text-blue transition">Maureen Montgomery, MD</a>
                    </div>
                    <svg viewBox="0 0 2 2" class="hidden md:inline mx-2 h-1 w-1 text-slate-500 fill-current" aria-hidden="true">
                        <circle cx="1" cy="1" r="1"></circle>
                    </svg>
                    <div class="flex items-center text-slate-500 gap-1">
                        <!-- <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mb-1" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <span class="font-gotham-light text-sm mr-px uppercase text-slate-500">Tags:</span>
                        <a href="https://project-teach.launchpaddev.com/pt_resources/?keyword=&amp;format%5B%5D=racism" class="font-gotham text-slate-500 hover:text-blue transition">COVID-19</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="w-full order-0 md:order-1 md:w-1/2">
            <div class="rounded-xl overflow-hidden relative w-full flex-1 aspect-[5/3] shadow-xl">
                <img class="object-cover h-full w-full" src="https://project-teach.launchpaddev.com/app/uploads/2023/08/image-20220318-130437-1.jpg">
            </div>
        </div>
    </div>
</div>
